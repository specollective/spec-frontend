      ...
      >
        ...
        <div
          ...
          <div
            ...
            data-te-carousel-item
          >
            {/* <img className="w-28 h-28  ml-39 mt-39 object-cover rounded-full border-2 border-black" src={Vector}></img> */}
        ...
        <button
          className="flex lg:visible absolute bottom-0 left-0 top-0 z-[1] w-[15%] items-center justify-center border-0 bg-none p-0 text-center text-white opacity-50 transition-opacity duration-150 ease-[cubic-bezier(0.25,0.1,0.25,1.0)] hover:text-white hover:no-underline hover:opacity-90 hover:outline-none focus:text-white focus:no-underline focus:opacity-90 focus:outline-none motion-reduce:transition-none"
          type="button"
