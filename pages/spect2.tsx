    ...
    <>
      ...
      <main className="flex min-h-screen items-center justify-content px-10 pt-10 md:w-2/3 2xl:w-1/2 m-auto">
        <div className="w-full">
          ...
          <footer className="p-10 bg-[#0C9FAA] py-10 px-10 mx-0  flex flex-col text-justify ">
            
          <button class=" block bg-[#FCD991]   w-13 h-10 ml-3 px-6  text-med font-medium text-black rounded-br-lg rounded-tl-lg font-montserrat w-3/4 m-auto ">
                Donate
                </button>
                <div className=" font-montserrat text-sm   ">
                © 2023 Sustainable Progress and Equality Collective
              </div>
            <section className="block float-right ">
              ...
              >
                ...
                <Image
                  className="float-right py-1 px-1  "
                  src="/github-logo.svg"
                  alt="github-logo"
                  width={25}
                  height={25}
              ...
              >
                ...
                />
                <div className=" float-right py-1 px-1 font-montserrat text-sm   ">
                Documentation
              </div>
