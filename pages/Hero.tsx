...
export default function Hero() {
  ...
  return (
    <section className="pb-29 flex max-w-[90rem] pl-[8rem]">
      <div id="top" className="pr-[8rem]">
        ...
        {/* scaling max-w-[25rem] */}
        <p className=" w-[25rem] font-montserrat text-3xl font-medium leading-10 text-spec-turquiose">
      ...
      <div className="relative">
        <Image src={training} alt="training-photo" className="min-w-[45rem]" />
